...
class Auth extends CI_Controller
{
    ...
    public function cek_regis()
    {
        ...
        Selamat Akunnu telah berhasil terdaftar, Silahkan Login!</div>');
        redirect('Auth');
    }
    ...
    public function logout()
    {
        ...
        $this->session->unset_userdata('message', '<div class="alert alert-danger" role="alert">Berhasil Logout!</div>');
        redirect('Auth');
    }
}
